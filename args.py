...
args_parser.add_argument('--batch_size', type=int, default=256, help='batch大小')
args_parser.add_argument('--hint_rate', type=float, default=0.9, help='避免模型坍塌的随机噪声率')
args_parser.add_argument('--alpha', type=float, default=6.9, help='损失函数的权重')
args_parser.add_argument('--beta', type=float, default=9.9, help='损失函数的权重')
...
args_parser.add_argument('--print_freq', type=int, default=10, help='信息显示的频率')
...
args_parser.add_argument('--kernel_size', type=list, default=[5, 7,5,1], help='卷积的核大小')
args_parser.add_argument('--drop_rate', type=float, default=0.5, help='避免过拟合的dropout概率')
args_parser.add_argument('--test_sampling_num', type=int, default=10000, help='测试时数据的大小')
...
args_parser.add_argument('--compare_datafile', type=str, default='tmp/chrom.1.data')
args_parser.add_argument('--compare_maskfile', type=str, default='tmp/mask.npy')
args_parser.add_argument('--clip_value', type=float, default=0.01)
